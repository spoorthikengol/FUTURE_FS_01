...
export const projects: Project[] = [
  ...
  },
  {
    ...
    links: [{ label: "Source", href: "https://github.com/shsumukha381-ui/NEURALNETWROKS" }],
  },
  {
    ...
    summary:
      "A medical imaging project focused on enhancing MRI scans and segmenting them — applying image processing and computer vision techniques to medical images.",
    ...
    caseStudy: [
      {
        heading: "Context",
        body: [
          "A computer vision project applying image enhancement and segmentation techniques to MRI scans.",
        ],
      },
      {
        heading: "Approach",
...
export const flagshipProject = projects.find((p) => p.kind === "flagship")!;
export const otherProjects = projects.filter((p) => p.kind !== "flagship");

  ...
  return (
    <section id="about" className="py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-6 sm:px-8">
        <SectionHeading eyebrow="About" title="Student by status. Builder by mindset." />
        ...
        <div className="mt-10 grid grid-cols-1 gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <Reveal>
            <p className="max-w-xl text-base leading-relaxed text-muted dark:text-muted-dark">
              I'm a student at {education.institution}, interested in AI, software
              development, full-stack systems, computer vision and using technology
              to solve real-world problems. Most of what's on this page came out of
              wanting to actually build the things I was reading about — a healthcare
              assistant, a computer-vision safety system, a medical-imaging pipeline —
